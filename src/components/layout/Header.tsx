...
const routeTitleMap: Record<string, { title: string; parent?: { title: string; path: string } }> = {
  ...
  '/items': { title: 'کالاها و خدمات' },
  '/items/products': { title: 'لیست کالاها', parent: { title: 'کالا و خدمات', path: '/items' } },
  '/items/services': { title: 'لیست خدمات', parent: { title: 'کالا و خدمات', path: '/items' } },
  '/items/new': { title: 'تعریف کالا / خدمت جدید', parent: { title: 'کالا و خدمات', path: '/items' } },
  '/items/categories': { title: 'دسته‌بندی کالا و خدمات', parent: { title: 'کالا و خدمات', path: '/items' } },
  '/items/units': { title: 'واحدهای اندازه‌گیری', parent: { title: 'کالا و خدمات', path: '/items' } },
  '/items/price-lists': { title: 'لیست‌های قیمت', parent: { title: 'کالا و خدمات', path: '/items' } },
